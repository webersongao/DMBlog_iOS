...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:
            NSLog(@"Wordpress");
            //            _xmlrpcURLSuffix = @"http://www.terwer.com/xmlrpc.php";
        ...
        case 1:
            NSLog(@"ZBlog");
            //            _xmlrpcURLSuffix = @"http://www.terwer.com:8080/xmlrpc";
        ...
        case 5:
            NSLog(@"51CTO");
            _xmlrpcURLPrefix = KOtherBlog;
            _xmlrpcURLSuffix = @"http://terwer.blog.51cto.com/xmlrpc.php";
            [self doSelectBlog];
            break;
        case 6:
            NSLog(@"Sina");
        ...
        case 7: {
            NSLog(@"JSON API");
            // JSON API 的方式 暂时未修改
            _xmlrpcURLSuffix = @"http://www.terwer.com/api/";
            NSUserDefaults *def = [NSUserDefaults standardUserDefaults];
