...
- (void)setBackground {
    ...
    bv1.alpha = 0.8f;
    bv1.backgroundColor = [UIColor colorWithRed:51/256.f green:51/256.f blue:51/256.f alpha:1.0];
    [self.view addSubview:bv1];
    
    UIView *bv2 = [[UIView alloc] initWithFrame:(CGRect){0, 150, (SCREEN_W-285)/2, 285}];
    bv2.alpha = 0.8f;
    bv2.backgroundColor = [UIColor colorWithRed:51/256.f green:51/256.f blue:51/256.f alpha:1.0];
    [self.view addSubview:bv2];
    
    UIView *bv3 = [[UIView alloc] initWithFrame:(CGRect){(SCREEN_W+285)/2, 150, (SCREEN_H-285)/2, 285}];
    bv3.alpha = 0.8f;
    bv3.backgroundColor = [UIColor colorWithRed:51/256.f green:51/256.f blue:51/256.f alpha:1.0];
    [self.view addSubview:bv3];
    
    UIView *bv4 = [[UIView alloc] initWithFrame:(CGRect){0, 435, SCREEN_W, SCREEN_H-435}];
    bv4.alpha = 0.8f;
    bv4.backgroundColor = [UIColor colorWithRed:51/256.f green:51/256.f blue:51/256.f alpha:1.0];
...
- (void)setCancelButton {
    ...
    [button setTitleColor: [UIColor colorWithRed:170/256.f green:170/256.f blue:170/256.f alpha:1.0] forState:UIControlStateSelected];
...
- (void)handleScanResult:(NSString *)result {
    ...
    if ([result hasPrefix:@"iunlocker://"]) {
        // 扫码登录
        targetController = [[WBSQRLoginViewController alloc] init];
        [targetController setUrl:result];
        
        [self.navigationController pushViewController:targetController animated:YES];
    } else if ([result hasPrefix:@"iunlocker-auth://"]) {
        // 扫码绑定
        targetController = [[WBSQROauthViewController alloc] init];
        [targetController setUrl:result];
