//
//  WBSOldHomePostViewController.m
//  DMBlog
//
...
#import "WBSOldHomePostViewController.h"
...
@implementation WBSOldHomePostViewController
...
-(void)fectchRecentPosts:(NSUInteger)page refresh:(BOOL)refresh{
    ...
    if ([WBSConfig isJSONAPIEnable]) {
        ...
        NSString *path = [[NSBundle mainBundle]pathForResource:@"DMBlogSetting" ofType:@"plist"];
